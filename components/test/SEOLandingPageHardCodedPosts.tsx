...
export default function LandingPage() {
  const posts = [
    {
      slug: "ai-resume-strategies",
      title: "5 AI Resume Strategies That Actually Work",
      date: "2024-11-15",
      description: "Learn how to optimize your resume with AI tools and stand out in today’s competitive job market."
    },
    {
      slug: "cover-letter-hacks",
      title: "Cover Letter Hacks: Tailor Faster, Apply Smarter",
      date: "2024-10-02",
      description: "Use these tricks to generate tailored cover letters with minimal effort using AI."
    },
    {
      slug: "resume-red-flags",
      title: "Avoid These Common Resume Red Flags",
      date: "2024-09-12",
      description: "Recruiters spot these red flags instantly—here’s how to fix them before you apply."
    }
  ]
