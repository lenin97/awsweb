...
import { getOgImageUrl } from '@/lib/seo/og';
...
export function createPageMetadata({
  ...
  image = {
    ...
    width: 1200,
    height: 630,
    alt: `${process.env.TCV_APP_NAME_HEADER} preview`,
  },
  baseUrl = process.env.TCV_BASE_DOMAIN!,
  languageAlternates = {
    'en-US': '/en-US',
    'es-PE': '/es-PE',
  },
  ...
  if (openGraphType === 'website'){
    ...
    openGraph = {
      ...
      url: canonicalUrl,
      siteName: process.env.TCV_APP_NAME_HEADER,
      type: openGraphType,
      images: ogImages,
    }
  }  
