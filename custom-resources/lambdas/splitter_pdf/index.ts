...
export function Splitter_PDF_Stack(
  scope: Construct,
  id: string,
  bucketl1: CfnBucket,
  bucketl2: IBucket,
  ...
  const splitter_pdf_Fn = new lambda.Function(scope, id, {
    functionName: 'tailorcv-pdf-splitter-lambda',
    runtime: lambda.Runtime.PYTHON_3_11,
    handler: "splitter_pdf.lambda_handler",
  ...
  bucketl2.grantReadWrite(splitter_pdf_Fn);

  splitter_pdf_Fn.addToRolePolicy(
